...
public class PlazaImagePromptBuilder {
    ...
    public String build(Plaza plaza, List<PlazaEntry> entries) {
        ...
        return """
                Create a polished, high-resolution illustration of a completed shared emotional plaza.
                The image should feel like a cozy isometric room/plaza scene made from the participants' objects.
                Preserve the mood of the Korean app "Weather of the Heart": warm, quiet, poetic, soft lighting, no readable text.
